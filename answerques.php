...
<?php
	...
	$select_que=mysqli_query($con,"select * from questions where question_id='$question_id'");
	$row_que=mysqli_fetch_array($select_que);
	$question=$row_que['question_cnt'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="col-sm-4 col-lg-4 col-xs-12">
			<div class="row">
				<nav  class="navbar navbar-default navbar-fixed-top" id="col3">
					...
					<h4 id="pagelabel"><b>Answer the Question!</b></h4>
				</nav>
			...
			<div class="row" style="margin-top:14%;">
				<div class="col-xs-12 col-sm-12 col-lg-12">
					<form name="post_form" method="post" action="" enctype="multipart/form-data">
						<p style="font-family:bold;font-size:1.75em;padding:10px;"><strong><?php echo $question; ?></strong></p>
						<textarea placeholder="write..." rows="5" cols="50" class="form-control" name="post_content" id="postarea" style="resize:none;"></textarea><br>
						<strong style="font-family:bold;font-size:1.5em;margin-left:10px;">Add Photo/video</strong><br>
						<label class='btn btn-default' style="width:30%;margin-top:10px;margin-left:10px;">Photo <input type='file' style="display:none;" name='selectimg' /></label>
						<hr>
